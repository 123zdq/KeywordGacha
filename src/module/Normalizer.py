...
class Normalizer:
    ...
    # 规范化  Unicode NFC标准化 + 全角转半角 + 控制字符清理 + 可选的空格合并。
    @classmethod
    def normalize(cls, text: str, merge_space: bool = True) -> str:
        ...
        text = unicodedata_normalize("NFC", text)
